...
If Julia's inheritance is viewed as a tree, inner-nodes represent abstract types with leaves are concrete structs - functionality is shared through composition rather than inheritance.
